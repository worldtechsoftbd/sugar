                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="text" class="form-control" id="notice_descriptiion" name="notice_descriptiion"
                                        placeholder="{{ localize('notice_descriptiion') }}" value="{{ old('notice_descriptiion') }}"
                                        required>
                                </div>
                            ...
                            <div class="row">
                                <label for="notice_date"
                                    class="col-form-label col-sm-3 col-md-12 col-xl-3 fw-semibold">{{ localize('notice_date') }}<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="text" class="form-control date_picker" id="notice_date" name="notice_date"
                                        placeholder="{{ localize('notice_date') }}" value="{{ old('notice_date') }}"
                                        required>
                                </div>
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="row">
                                <label for="notice_attachment"
                                    class="col-form-label col-sm-3 col-md-12 col-xl-3 fw-semibold">{{ localize('notice_attachment') }}<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="file" class="form-control" id="notice_attachment" name="notice_attachment"
                                        placeholder="{{ localize('notice_attachment') }}"
                                        value="{{ old('notice_attachment') }}" required>
                                </div>
