<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" class="form-control" id="name" name="name"
                    placeholder="{{ localize('award_name') }}" value="{{ old('name') }}" required>
            </div>
    ...
    <div class="col-md-12 mt-3">
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <textarea class="form-control" name="description" id="description" placeholder="{{ localize('award_description') }}">{{ old('description') }}</textarea>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" class="form-control" id="gift" name="gift"
                    placeholder="{{ localize('gift_item') }}" value="{{ old('gift') }}" required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" name="date" id="date" class="form-control date_picker"
                    placeholder="{{ localize('date') }}" value="{{ old('date') }}" required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" class="form-control" name="awarded_by" id="awarded_by"
                    placeholder="{{ localize('award_by') }}" value="{{ old('awarded_by') }}" required>
            </div>
