<!-- Modal -->
<div class="modal fade" id="addBank" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="leadForm" action="{{ route('bank.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="text" class="form-control" id="bank_name" name="bank_name"
                                        placeholder="{{ localize('bank_name') }}" value="{{ old('bank_name') }}"
                                        required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="text" class="form-control" id="branch_name" name="branch_name"
                                        placeholder="{{ localize('branch_name') }}" value="{{ old('branch_name') }}"
                                        required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="text" class="form-control" id="account_name" name="account_name"
                                        placeholder="{{ localize('account_name') }}" value="{{ old('account_name') }}"
                                        required>
                                </div>
