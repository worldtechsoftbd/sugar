...
@section('content')
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="fs-17 fw-semi-bold mb-0">Select Employee</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <form class="row g-3" action="" method="GET">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3 mx-0 pb-3 row">
                                                    <label class="col-md-3 col-form-label ps-0">Employee<span
    ...
    <div class="card mb-4">
        ...
        <div class="card-header mt-2">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">Loan Report</h6>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table id="example" class="table display table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="15%">Total Loan</th>
                            <th width="15%">Total Amount</th>
                            <th width="20%">Repayment Total</th>
                        </tr>
                    </thead>
                    <tbody>
