...
@section('title', localize('npf3_soc_sec_tax_report'))
@push('css')
@endpush
@section('content')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('npf3_soc_sec_tax_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
        ...
        <div class="card-body">
            ...
            <div class="table_customize">
                <input type="hidden" id="url" value="{{ route('reports.npf3-soc-sec-tax-report-show') }}" />
