<!-- Modal -->
<div class="modal fade" id="addPointCategory" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">
                    {{ localize('new_point_category') }}
                </h5>
            </div>
            <form id="leadForm" action="{{ route('reward.point-category-store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    <input type="text" class="form-control" id="point_category" name="point_category"
                                        placeholder="{{ localize('category_name') }}" value="{{ old('point_category') }}"
                                        required>
                                </div>
