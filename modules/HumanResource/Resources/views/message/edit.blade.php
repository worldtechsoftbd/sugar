<!-- Modal -->
<div class="modal fade" id="editMessage{{ $data->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="leadForm" action="{{ route('message.update', $data->uuid) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    ...
                                    <select name="receiver_id" id="receiver_id" class="form-control select-basic-single" required>
                                        ...
                                        @foreach ($employees as $employee)
                                            ...
                                            <option value="{{ $employee->id }}" {{ $employee->id == $data->receiver_id ? 'selected' : '' }}>{{ $employee->full_name }}
                                            </option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-md-12 col-xl-9">
                                    ...
                                    <textarea  class="form-control" id="message" name="message"
                                        placeholder="{{ localize('message') }}" rows ="5" required>{{ $data->message }}</textarea>
                                </div>
