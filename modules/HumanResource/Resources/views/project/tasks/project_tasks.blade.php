...
@section('content')
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="example" class="table display table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        @forelse($project_tasks as $key => $data)
    ...
    <div class="modal fade" id="taskDetailsModal" aria-labelledby="taskDetailsModalLabel" aria-hidden="true">
        ...
        <!-- Hidden data -->
        <input type="hidden" id="project_task_create" value="{{ route('project.project-task-create',':project_id') }}">
        <input type="hidden" id="project_task_store" value="{{ route('project.project-task-store',':project_id') }}">

        <input type="hidden" id="lang_create_task" value="{{ localize('create_task') }}">

        <input type="hidden" id="project_task_edit" value="{{ route('project.project-task-edit', ':task_id') }}">
        <input type="hidden" id="project_task_update" value="{{ route('project.project-task-update',':task_id') }}">
...
<script src="{{ module_asset('HumanResource/js/project-tasks.js') }}"></script>
@endpush
