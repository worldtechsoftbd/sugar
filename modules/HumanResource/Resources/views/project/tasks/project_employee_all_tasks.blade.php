...
@section('content')
    ...
    <div class="modal fade" id="taskDetailsModal" aria-labelledby="taskDetailsModalLabel" aria-hidden="true">
        ...
        <!-- Hidden data -->
        <input type="hidden" id="employee_project_task_create" value="{{ route('project.employee-project-task-create',':project_id') }}">
        <input type="hidden" id="employee_project_task_store" value="{{ route('project.employee-project-task-store',':project_id') }}">

        <input type="hidden" id="lang_create_task" value="{{ localize('create_task') }}">

        <input type="hidden" id="employee_project_task_edit" value="{{ route('project.employee-project-task-edit', ':task_id') }}">
        <input type="hidden" id="employee_project_task_update" value="{{ route('project.employee-project-task-update',':task_id') }}">
...
<script src="{{ module_asset('HumanResource/js/project-employee-tasks.js') }}"></script>
@endpush
