                    ...
                    <tbody>
                        @forelse($project_lists as $key => $data)
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('read_task')
                                        <a href="{{ route('project.employee-project-tasks',$data->id) }}" class="btn btn-success-soft btn-sm me-1" title="Edit">{{localize('own_tasks')}}</a>
                                    @endcan
                                    @can('read_task')
                                        <a href="{{ route('project.project-all-tasks',$data->id) }}" class="btn btn-info-soft btn-sm me-1" title="Edit">{{localize('all_tasks')}}</a>
                                    @endcan
                                    @can('read_sprint')
                                        <a href="{{ route('project.empl-project-sprints',$data->id) }}" class="btn btn-primary-soft btn-sm me-1" title="Edit">{{localize('sprints')}}</a>
                                    @endcan
                                </td>
                            </tr>
