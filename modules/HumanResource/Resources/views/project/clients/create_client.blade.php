        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" class="form-control" id="client_name" name="client_name"
                    placeholder="{{ localize('client_name') }}" value="{{ old('client_name') }}"
                    required>
            </div>
    ...
    <div class="col-md-12 mt-3">
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                ...
                <select name="country" id="country" class="form-control select-basic-single" required>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" class="form-control" id="email" name="email"
                    placeholder="{{ localize('email') }}" value="{{ old('email') }}"
                    required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                <input type="text" class="form-control" id="company_name" name="company_name"
                    placeholder="{{ localize('company_name') }}" value="{{ old('company_name') }}"
                    required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-12 col-xl-9">
                ...
                <textarea  class="form-control" id="address" name="address"
                    placeholder="{{ localize('address') }}" rows ="5" required></textarea>
            </div>
