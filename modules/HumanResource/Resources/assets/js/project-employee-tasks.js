function addTaskDetails(project_id) {
    ...
    var url = $("#employee_project_task_create").val();
    ...
    $.ajax({
        ...
        success: function(data) {
            var f_up_url = $("#employee_project_task_store").val();
...
function editTaskDetails(task_id) {
    ...
    var url = $("#employee_project_task_edit").val();
    ...
    $.ajax({
        ...
        url: url,
        success: function(data) {
            var f_up_url = $("#employee_project_task_update").val();
