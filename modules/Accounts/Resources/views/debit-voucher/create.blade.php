    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('debit_voucher') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
        ...
        <div class="card-body">
            <form id="leadForm" action="{{ route('debit-vouchers.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="debits[1][ledger_comment]" value=""
                                        class="form-control total_dprice text-end" id="txtDebit_1" autocomplete="off">
                                </td>
                                <td>
