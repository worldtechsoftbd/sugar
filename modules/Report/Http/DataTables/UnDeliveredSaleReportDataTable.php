...
class UnDeliveredSaleReportDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->rawColumns(['customer_name', 'invoice', 'total_amount', 'due_amount', 'paid_amount']);
    ...
    public function query(Invoice $model): QueryBuilder
    {
        ...
        return $model->newQuery()
            ->with(['customer', 'admin'])->where(function ($query) {
            $query->where('sale_type', 1)->orWhere('sale_type', 3);
        })->where('all_delivered', 0)->take(10)->orderBy('id', 'DESC')
                               ...
                               //add print date and time
                                $(win.document.body)
                                    .prepend(
                                        ...
                                        \'<h5 class="text-center">Undelivered Sales Report</h5>\'+
