...
use Modules\Sale\Entities\InvoiceDetails;
...
class CategoryWiseSalesReportDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->rawColumns(['category_name', 'brand_name', 'product_name', 'model', 'quantity', 'price', 'amount']);
     ...
     */
    public function query(InvoiceDetails $model): QueryBuilder
    {

        $sale_date = $this->request->get('sale_date');
        ...
        return $model->newQuery()
            ...
            ->when($sale_date, function ($query) use ($sale_date) {
                $string = explode('-', $sale_date);
                if ($sale_date) {
                ...
                return $query->whereBetween('sales_date', [$fromDate, $toDate]);
            })
            ->where('all_delivered', 1)
            ...
            ->orderBy('sales_date', orderByData($this->request->get('order')));
    }
        ...
        return $this->builder()
            ...
            ->footerCallback('function ( row, data, start, end, display ) {
                       ...
                       var amount = api
                        ...
                        quantity = bt_number_format(quantity);
                        ...
                        $(api.column( 7 ).footer() ).html(price);
                               ...
                               //add print date and time
                                $(win.document.body)
                                    .prepend(
                                        ...
                                        \'<h5 class="text-center">Category Wise Sale Report</h5>\'+
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('sales_date')
                ->title(localize('sale_date')),
