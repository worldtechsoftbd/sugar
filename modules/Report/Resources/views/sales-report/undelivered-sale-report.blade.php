...
@section('title', localize('undelivered_sales_report'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('undelivered_sales_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-4 align-self-end">
                                        <button type="button" name="filter" id="filter"
                                            class="btn btn-primary">{{ localize('filter') }}</button>
