...
@section('title', localize('day_wise_sales_report'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('day_wise_sales_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
...
@push('js')
    ...
    <script src="{{ module_asset('Report/js/day-wise-sale-report.js') }}"></script>
@endpush
