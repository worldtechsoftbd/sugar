...
@section('title', localize('sale_return_report'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('sale_return_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                        ...
                        <div class="accordion-item">
                            <div id="flush-collapseOne" class="accordion-collapse collapse bg-white mb-4"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-4">
                                        <input type="number" class="form-control" id="return_no"
                                            placeholder="{{ localize('return_no') }}">
                                    </div>
                                    <div class="col-md-2 mb-4">
...
@push('js')
    ...
    <script src="{{ module_asset('Report/js/sale-return-report.js') }}"></script>
