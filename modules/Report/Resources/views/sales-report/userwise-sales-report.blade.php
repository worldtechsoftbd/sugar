...
@section('title', localize('user_wise_sales_report'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('user_wise_sales_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse bg-white mb-4"
                                ...
                                <div class="row">
                                    <div class="col-md-2 mb-4">
                                        <select id="sale_by" class="select-basic-single" data-url="{{ $sale_by_url }}">
...
@push('js')
    ...
    <script src="{{ module_asset('Report/js/user-wise-sale-report.js') }}"></script>
