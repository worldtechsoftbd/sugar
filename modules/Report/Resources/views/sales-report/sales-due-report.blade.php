...
@section('title', localize('sales_due_report'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('sales_due_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-4 align-self-end">
                                        <button type="button" name="filter" id="filter" class="btn btn-primary"><i
                                                class="fa-sharp fa-solid fa-search"></i>
                                            {{ localize('search') }}</button>
                                        <button type="button" name="reset" id="reset" class="btn btn-danger"><i
                                                class="fa-sharp fa-solid fa-sync"></i> {{ localize('reset') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('js')
    ...
    <script src="{{ module_asset('Report/js/sale-due-report.js') }}"></script>
