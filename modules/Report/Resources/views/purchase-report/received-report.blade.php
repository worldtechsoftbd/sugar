...
@section('title', localize('received_details_report'))
@push('css')
...
@section('content')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('received_details_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse bg-white mb-4"
                                ...
                                <div class="row">
                                    <div class="col-md-2 mb-4">
                                        <input type="number" class="form-control" id="receive_no"
                                            placeholder="{{ localize('receive_no') }}">
                                    </div>
                                    <div class="col-md-2 mb-4">
                                    ...
                                    <div class="col-md-2 mb-4">
                                        <input type="text" class="form-control date-range" id="receive_date"
                                            autocomplete="off" placeholder="{{ localize('receive_date') }}">
                                    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="receiveDetailsViewModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ localize('receive_details') }}</h5>
...
@push('js')
    ...
    <script src="{{ module_asset('Report/js/receive-report.js') }}"></script>
@endpush
