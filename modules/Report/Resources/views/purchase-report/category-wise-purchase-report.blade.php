...
@section('title', localize('category_wise_purchase_report'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('category_wise_purchase_report') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                        ...
                        <div class="accordion-item">
                            <div id="flush-collapseOne" class="accordion-collapse collapse bg-white mb-4"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-4">
                                        <select id="supplier_id" class="select-basic-single" data-url="{{ $supplier_url }}">
...
@push('js')
    ...
    <script src="{{ module_asset('Report/js/category-wise-purchase-report.js') }}"></script>
@endpush
